import { SELECT_CATEGORY, UPDATE_CATEGORY_LIST } from "../actions/types";
...
export default function(state = initialState, action) {
  switch (action.type) {
    case SELECT_CATEGORY:
      console.log(
        "categories reducer - select category:" + action.selectedCategory
      );
      return { ...state, selectedCategory: action.selectedCategory };
    case UPDATE_CATEGORY_LIST:
      console.log(
        "categories reducer - update category list:" +
          action.filteredCategoryList
      );
      return { ...state, filteredCategoryList: action.filteredCategoryList };
    default:
