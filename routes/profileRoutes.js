...
module.exports = (app) => {
  ...
  app.get('/api/profile/handle/:handle', (req, res) => { // public route therefore no need for passport middleware
    const errors = {};
  ...
  // get profile by user
  app.get('/api/profile/user/:user_id', (req, res) => { // public route therefore no need for passport middleware
    const errors = {};
  ...
  app.delete(
    ...
    (req, res) => {
      Profile.findOneAndRemove({
        ...
        User.findOneAndRemove({ // this deletes the user too
          _id: req.user.id
        }).then(() =>
          res.json({
            success: true
